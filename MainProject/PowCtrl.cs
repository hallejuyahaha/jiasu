...
namespace WitiVelocity
{
    public static class PowCtrl
    {
        ...
        public static void setCurrentPowerEnumerateVistaAPI(uint num)
        {
            ...
            try
            {
                ...
                Guid powerSchemaGuid = Guid.Parse("a1841308-3541-4fab-bc81-f71556f20b4a");
                ...
                Guid minStateGuid = Guid.Parse("893dee8e-2bef-41e0-89c6-b55d0929964c");

                while (
                    PowerEnumerate(IntPtr.Zero, activeGuidPtr, ref GUID_PROCESSOR_SETTINGS_SUBGROUP,
                    18, index, ref VideoSettingGuid, ref BufferSize) == 0)
                {
                    if (VideoSettingGuid.CompareTo(minStateGuid) == 0)
                    {
                        ...
                        res = PowerReadACValueIndex(IntPtr.Zero, activeGuidPtr, IntPtr.Zero,
                            ref VideoSettingGuid, ref size);
                        ...
                        Guid subGroupGuid = Guid.Parse("54533251-82be-4824-96c1-47b60b740d00");
                        res = PowerWriteACValueIndex(IntPtr.Zero, activeGuidPtr, ref subGroupGuid,
                        ref VideoSettingGuid, num);
                        SetActivePwrScheme(0,IntPtr.Zero, IntPtr.Zero);
                    }
